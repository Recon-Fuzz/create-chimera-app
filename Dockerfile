## Build with
## docker build -t nican0r/echidna-runner:latest .

## Run image with
## docker run -it --rm -v $PWD:/code nican0r/echidna-runner

## Run ECHIDNA with
## cd ./code/create-chimera-app && echidna . --contract CryticTester --config echidna.yaml
